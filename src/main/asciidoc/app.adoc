...
include::{snippetsDir}/ScreenshotTest/documentCreateNoteScenario/index.adoc[]
...
----
include::{snippetsDir}/FrontEndBackEndTransactionTest/describeLoadNotesTransaction/sequenceDiagram.puml[]
----
...
[plantuml, febe-create-note-diagram, svg]
----
include::{snippetsDir}/FrontEndBackEndTransactionTest/describeCreateNoteTransaction/sequenceDiagram.puml[]
----
